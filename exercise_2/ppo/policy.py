...
class Policy(object):
    ...
    def __init__(self, obs_dim, act_dim, kl_targ, hid1_mult, policy_logvar, clipping_range=None, dir="data"):
        """
        Args:
        ...
        """
        self.path = os.path.join("Model", dir, 'policy')
    ...
    def _policy_nn(self):
        ...
        out =  None ### YOUR IMPLEMENT PART ###
        self.means = None ### YOUR IMPLEMENT PART ###
    ...
    def _loss_train_op(self):
        ...
        if self.clipping_range is not None:
            ...
            ### FIXME STEP 4 using self.clipping_range

            pg_ratio = tf.exp(self.logp - self.logp_old)
            clipped_pg_ratio = ### YOUR IMPLEMENT PART ###
            surrogate_loss = ### YOUR IMPLEMENT PART ###
    ...
    def save_model(self):
        self.saver.save(self.sess, self.path+'/actor', global_step=self.global_step)
